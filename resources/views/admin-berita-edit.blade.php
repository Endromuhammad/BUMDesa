                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h4 class="header-title mb-0">Berita Update</h4>
                                </div>
                                <div>
                                    <form>
                                        <br>
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" placeholder="ID tidak dapat diganti" aria-label="Disabled input example" disabled>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="name" class="form-control" id="exampleFormControlInput1" placeholder="Judul Berita">
                                        </div>
                                        <div class="mb-3">
