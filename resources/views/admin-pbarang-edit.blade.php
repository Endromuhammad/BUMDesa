                        ...
                        <div class="breadcrumbs-area clearfix">
                            <div class="col-md-6 col-sm-8 clearfix">
                                ...
                                <div class="search-box pull-left">
                                     <h4 class="page-title pull-left">Peminjaman Barang</h4>
                                        <ul class="breadcrumbs pull-left">
                                            <li><a href="admin.html">Home</a></li>
                                            <li><span>Peminjaman Barang</span></li>
                                            <li><span> / Edit Peminjaman Barang </span></li>
                                        </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h4 class="header-title mb-0">Edit Data Peminjaman Barang</h4>
                                </div>
                                <div>
                                    <form>
                                        <br>
                                        ...
                                        <div class="mb-3">
                                            <label for="formjudul" class="form-label">No Telpon</label>
                                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Judul Porto">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="formjudul" class="form-label">Barang yang dipilih</label>
                                            <input type="name" class="form-control" id="exampleFormControlInput1" placeholder="Kategori">
                                        </div>
                                        <div class="mb-3">
                                            <label for="formjudul" class="form-label">Tanggal Peminjaman</label>
                                            <input type="date" class="form-control" id="exampleFormControlInput1">
                                        </div>
                                        <div class="mb-3">
                                            <label for="formjudul" class="form-label">Tanggal Pengembalian</label>
                                            <input type="date" class="form-control" id="exampleFormControlInput1">
                                        </div>
                                        <div class="mb-3">
